...
url='https://www.livefutbol.com/calendario/esp-frauen-primera-division-2021-2022-spieltag/30/'
...
url_principal='https://www.livefutbol.com/calendario/esp-frauen-primera-division-'
for años in (eq[1].find_all('form')[0].find_all('option')):
    ...
    if (añosarreglados =='2016-2017 '):
        url_iterada='https://www.livefutbol.com/calendario/esp-primera-division-2016-2017-spieltag_2/'
    elif (añosarreglados =='1986-1987 Primera fase'):
        url_iterada = 'https://www.livefutbol.com/calendario/esp-primera-division-1986-1987-vorrunde-spieltag/'
    elif (añosarreglados =='1986-1987 Playoff 7-12'):
        url_iterada = 'https://www.livefutbol.com/calendario/esp-primera-division-1986-1987-playoff-7-12-spieltag/'
    elif (añosarreglados == '1986-1987 Playoff 13-18'):
        url_iterada = 'https://www.livefutbol.com/calendario/esp-primera-division-1986-1987-playoff-13-18-spieltag/'
    elif (añosarreglados == '1986-1987 Playoff 1-6'):
        url_iterada = 'https://www.livefutbol.com/calendario/esp-primera-division-1986-1987-playoff-1-6-spieltag/'
    else:
    ...
    for jornada in list(range(len(eq[1].find_all('form')[1].find_all('option'))-1,-1,-1)):
        ...
        # recordar cambiar en los links el "/" por "-"
        if (añosarreglados == '2016-2017 '):
            url_iterada = 'https://www.livefutbol.com/calendario/esp-primera-division-2016-2017-spieltag_2/'+jornada_numero[0]+'/'
        elif (añosarreglados == '1986-1987 Primera fase'):
            url_iterada = 'https://www.livefutbol.com/calendario/esp-primera-division-1986-1987-vorrunde-spieltag/'+jornada_numero[0]+'/'
        elif (añosarreglados == '1986-1987 Playoff 7-12'):
            url_iterada = 'https://www.livefutbol.com/calendario/esp-primera-division-1986-1987-playoff-7-12-spieltag/'+jornada_numero[0]+'/'
        elif (añosarreglados == '1986-1987 Playoff 13-18'):
            url_iterada = 'https://www.livefutbol.com/calendario/esp-primera-division-1986-1987-playoff-13-18-spieltag/'+jornada_numero[0]+'/'
        elif (añosarreglados == '1986-1987 Playoff 1-6'):
            url_iterada = 'https://www.livefutbol.com/calendario/esp-primera-division-1986-1987-playoff-1-6-spieltag/'+jornada_numero[0]+'/'
        else:
        ...
        for x in (eq[2].table.find_all('tr')):
            ...
            for y in list(range(0, 7)):
                ...
                #goles
                    ...
                    print(url_iterada)
                    z_lista = z.split(':')
                    if (z=='-:- ' or z=='-:-  ' or z==' -:- ' or z==' no jug.' or z=='no jug. '):
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results_f/laliga_femenina_results',index=False)
print(df)
