...
url='https://www.livefutbol.com/calendario/bundesliga-2021-2022-spieltag/34/'
...
url_principal='https://www.livefutbol.com/calendario/bundesliga-'
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results/bundesliga_results',index=False)
print(df)
