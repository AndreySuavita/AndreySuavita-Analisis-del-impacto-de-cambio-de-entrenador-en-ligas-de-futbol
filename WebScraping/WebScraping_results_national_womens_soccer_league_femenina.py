...
url = 'https://www.livefutbol.com/calendario/usa-frauen-national-womens-soccer-league-2022-playoffs-finale/0/'
...
url_principal = 'https://www.livefutbol.com/calendario/usa-frauen-national-womens-soccer-league-'
for años in (eq[1].find_all('form')[0].find_all('option')):
    ...
    if (añosarreglados in ['2022-Playoffs','2021-Playoffs','2020-Fall-Series','2020-Challenge-Cup','2019-Playoffs','2018-Playoffs','2017-Playoffs',
                            '2016-Playoffs','2015-Playoffs','2014-Playoffs','2013-Playoffs']):
        continue
    elif(añosarreglados == "2013"):
        url_iterada == 'https://www.livefutbol.com/calendario/usa-frauen-nwsl-2013-spieltag/5/'
    else:
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results_f/national_womens_soccer_league_femenina_results',index=False)
print(df)
