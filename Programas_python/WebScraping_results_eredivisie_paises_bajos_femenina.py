...
url='https://www.livefutbol.com/calendario/ned-frauen-eredivisie-2021-2022-spieltag/27/'
...
url_principal='https://www.livefutbol.com/calendario/ned-frauen-eredivisie-'
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results_f/eredivisie_paises_bajos_femenina_results',index=False)
print(df)
