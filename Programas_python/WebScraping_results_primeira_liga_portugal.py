...
url='https://www.livefutbol.com/calendario/por-primeira-liga-2021-2022-spieltag/34/'
...
url_principal='https://www.livefutbol.com/calendario/por-primeira-liga-'
for años in (eq[1].find_all('form')[0].find_all('option')):
    ...
    if (añosarreglados == '2012-2013' or añosarreglados == '2011-2012'):
        url_iterada = 'https://www.livefutbol.com/calendario/por-liga-zon-sagres-'+añosarreglados+'/'
    elif (añosarreglados == '2010-2011'):
        url_iterada = 'https://www.livefutbol.com/calendario/por-liga-sagres-'+añosarreglados
    elif (añosarreglados == '2009-2010' or añosarreglados == '2008-2009' or añosarreglados == '2007-2008' or añosarreglados == '2006-2007' or añosarreglados == '2005-2006' or añosarreglados == '2004-2005' or añosarreglados == '2003-2004' or añosarreglados == '2002-2003'):
        url_iterada = 'https://www.livefutbol.com/calendario/por-superliga-'+añosarreglados+'-spieltag/'
    else:
    ...
    for jornada in list(range(len(eq[1].find_all('form')[1].find_all('option'))-1,-1,-1)):
        ...
        # recordar cambiar en los links el "/" por "-"
        if (añosarreglados == '2012-2013' or añosarreglados == '2011-2012'):
            url_iterada = 'https://www.livefutbol.com/calendario/por-liga-zon-sagres-' + añosarreglados + '-spieltag/' + jornada_numero[0]+'/'
        elif (añosarreglados == '2010-2011'):
            url_iterada = 'https://www.livefutbol.com/calendario/por-liga-sagres-' + añosarreglados + '-spieltag/' + jornada_numero[0]+'/'
        elif (añosarreglados == '2009-2010' or añosarreglados == '2008-2009' or añosarreglados == '2007-2008' or añosarreglados == '2006-2007' or añosarreglados == '2005-2006' or añosarreglados == '2004-2005' or añosarreglados == '2003-2004' or añosarreglados == '2002-2003'):
            url_iterada = 'https://www.livefutbol.com/calendario/por-superliga-' + añosarreglados + '-spieltag/'+ jornada_numero[0]+'/'
        else:
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results/primeira_liga_portugal_results',index=False)
print(df)
