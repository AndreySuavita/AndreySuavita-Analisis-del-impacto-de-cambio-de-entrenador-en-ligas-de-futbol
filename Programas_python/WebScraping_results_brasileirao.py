...
url = 'https://www.livefutbol.com/calendario/bra-serie-a-2022-spieltag/38/'
...
url_principal = 'https://www.livefutbol.com/calendario/bra-serie-a-'
for años in (eq[1].find_all('form')[0].find_all('option')):
    ...
    if (añosarreglados in ['2002-Championship-Playoffs','2001-Championship-Playoffs','2000-Yellow-Module-Playoffs','2000-Championship-Playoffs','1999-Championship-Playoffs',
                           '1998-Championship-Playoffs','1997-Final','1996-Championship-Playoffs','1995-Championship-Playoffs']):
        continue
    elif (añosarreglados == '1995-1st-Phase-Gr.-B'):
        url_iterada = 'https://www.livefutbol.com/calendario/bra-serie-a-1995-1st-phase-gr-b-spieltag/'
    elif (añosarreglados == '1995-1st-Phase-Gr.-A'):
        url_iterada = 'https://www.livefutbol.com/calendario/bra-serie-a-1995-1st-phase-gr-a-spieltag/'
    else:
    ...
    for jornada in list(range(len(eq[1].find_all('form')[1].find_all('option'))-1,-1,-1)):
        if (eq[1].find_all('form')[1].find_all('option')[jornada]) in ["Final","Semifinales","Cuartos de final","Grupo A","Grupo B","Final"]:
            ...
            añosarreglados = añosarreglados.replace(' ', '-')
            # recordar cambiar en los links el "/" por "-"
            if (añosarreglados == '1995-1st-Phase-Gr.-B'):
                url_iterada = 'https://www.livefutbol.com/calendario/bra-serie-a-1995-1st-phase-gr-b-spieltag/'+jornada_numero[0]+'/'
            elif (añosarreglados == '1995-1st-Phase-Gr.-A'):
                url_iterada = 'https://www.livefutbol.com/calendario/bra-serie-a-1995-1st-phase-gr-a-spieltag/'+jornada_numero[0]+'/'
            else:
            ...
            for x in (eq[2].table.find_all('tr')):
                ...
                for y in list(range(0, 7)):
                    ...
                    # goles
                        ...
                        print(url_iterada)
                        z_lista = z.split(':')
                        if (z == '-:- ' or z == '-:-  ' or z == ' -:- ' or z == ' no jug. 'or z == 'no jug. '  or z == ' no jug.' or z == ' apla.' or z == 'apla. '):
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results/brasileirao_results', index=False)
print(df)
