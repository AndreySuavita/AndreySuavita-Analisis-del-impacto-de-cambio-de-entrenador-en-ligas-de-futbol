...
url='https://www.livefutbol.com/calendario/fra-frauen-division-1-2021-2022-spieltag/22/'
...
url_principal='https://www.livefutbol.com/calendario/fra-frauen-division-1-'
        ...
        for x in (eq[2].table.find_all('tr')):
            ...
            for y in list(range(0, 7)):
                ...
                #goles
                    ...
                    print(url_iterada)
                    z_lista=z.split(':')
                    if (z=='-:- ' or  z==' no jug.' or z=='no jug. 'or z==' no jug. '):
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results_f/ligue_1_femenina_results',index=False)
print(df)
