...
url='https://www.livefutbol.com/calendario/nor-frauen-toppserien-2022-playoffs-spieltag/6/'
...
url_principal='https://www.livefutbol.com/calendario/nor-frauen-toppserien-'
for años in (eq[1].find_all('form')[0].find_all('option')):
    añosarreglados = años.text
    añosarreglados = añosarreglados.replace('/', '-')
    if (añosarreglados == '2022 Playoffs'):
        url_iterada ='https://www.livefutbol.com/calendario/nor-frauen-toppserien-2022-playoffs-spieltag/'
    else:
    ...
    for jornada in list(range(len(eq[1].find_all('form')[1].find_all('option'))-1,-1,-1)):
        ...
        añosarreglados=añosarreglados.replace('/','-')
        if (añosarreglados == '2022 Playoffs'):
            url_iterada = 'https://www.livefutbol.com/calendario/nor-frauen-toppserien-2022-playoffs-spieltag/'+jornada_numero[0]+'/'
        else:
        ...
        for x in (eq[2].table.find_all('tr')):
            ...
            for y in list(range(0, 7)):
                ...
                #goles
                    ...
                    print(url_iterada)
                    z_lista=z.split(':')
                    if (z == '-:- ' or z == '-:-  ' or z == ' -:- ' or z == ' no jug. ' or z == 'no jug. ' or z == ' no jug.' or z == ' apla.' or z == 'apla. ' or z == ' susp.' or z == 'anu. '):
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results_f/toppserien_noruega_femenina_results',index=False)
print(df)
