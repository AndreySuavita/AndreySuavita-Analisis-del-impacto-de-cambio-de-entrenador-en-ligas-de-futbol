...
url='https://www.livefutbol.com/calendario/ita-serie-a-2021-2022-spieltag/38/'
...
url_principal='https://www.livefutbol.com/calendario/ita-serie-a-'
for años in (eq[1].find_all('form')[0].find_all('option')):
    ...
    if (añosarreglados =='2004-2005 Abstieg' or añosarreglados =='1999-2000 Playoff' or añosarreglados =='1998-1999 Uefa-Cup' or añosarreglados == '1960-1961 Relegation'):
        continue
    elif (añosarreglados =='1945-1946 Sur'):
        url_iterada = 'https://www.livefutbol.com/calendario/ita-serie-a-1945-1946-sued-spieltag/'
    elif (añosarreglados =='1945-1946 Norte '):
        url_iterada = 'https://www.livefutbol.com/calendario/ita-serie-a-1945-1946-nord-spieltag/'
    elif (añosarreglados == '1945-1946 Fase final'):
        url_iterada = 'https://www.livefutbol.com/calendario/ita-serie-a-1945-1946-endrunde-spieltag/'
    else:
    ...
    for jornada in list(range(len(eq[1].find_all('form')[1].find_all('option'))-1,-1,-1)):
        ...
        if (añosarreglados == '2004-2005 Abstieg' or añosarreglados == '1999-2000 Playoff' or añosarreglados == '1998-1999 Uefa-Cup' or añosarreglados == '1960-1961 Relegation'):
            ...
            url_iterada = 'https://www.livefutbol.com/calendario/ita-serie-a-1945-1946-sued-spieltag/'+jornada_numero[0]+'/'
        elif (añosarreglados == '1945-1946 Norte '):
            url_iterada = 'https://www.livefutbol.com/calendario/ita-serie-a-1945-1946-nord-spieltag/'+jornada_numero[0]+'/'
        elif (añosarreglados == '1945-1946 Fase final'):
            url_iterada = 'https://www.livefutbol.com/calendario/ita-serie-a-1945-1946-endrunde-spieltag/'+jornada_numero[0]+'/'
        else:
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results/serie_a_italia_results',index=False)
print(df)
