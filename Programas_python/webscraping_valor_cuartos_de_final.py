...
## para finales
url='https://www.livefutbol.com/calendario/col-primera-a-2021-apertura-playoffs-viertelfinale/0/'
...
fecha=[]
contador = -1
print(eq[2].table.find_all('tr')[2])
for x in (eq[2].table.find_all('tr')):
    contador = contador + 1
    if contador == 3 or contador == 7 or contador == 11 or contador == 15:
      continue
    if contador == 2 or contador == 6 or contador == 10 or contador == 14:
      tag = x.find_all('td')
