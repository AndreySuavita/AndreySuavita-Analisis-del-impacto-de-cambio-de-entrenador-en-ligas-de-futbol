...
url='https://www.livefutbol.com/calendario/frauen-bundesliga-2021-2022-spieltag/22/'
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results_f/bundesliga_femenina_results',index=False)
print(df)
