...
partidos= pd.read_csv("D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results/europa_results")
entrenadores= pd.read_csv("D:/MEGAsync/andrey u/Maestría/Tesis/managers/europa_managers")
...
partidos.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_unificados/europa_resultados.csv',index=False)
print(partidos)