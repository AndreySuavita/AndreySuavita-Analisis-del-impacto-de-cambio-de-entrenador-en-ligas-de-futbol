...
url='https://www.livefutbol.com/calendario/eng-frauen-womens-super-league-2021-2022-spieltag/22/'
...
url_principal='https://www.livefutbol.com/calendario/eng-frauen-womens-super-league-'
...
df.to_csv('D:/MEGAsync/andrey u/Maestría/Tesis/datasets_results_f/premier_league_femenina_results',index=False)
print(df)
